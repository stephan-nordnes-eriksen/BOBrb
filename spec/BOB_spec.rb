...
describe BOB do
  ...
  # end
	...
	it "ul do with external data" do
		data = [1,2,3];
		expect( BOB.new("ul").do(data).insert("li", {"data-property" => BOB.data}).id(BOB.data).s() ).to eq("<ul><li id=\"1\" data-property=\"1\"></li><li id=\"2\" data-property=\"2\"></li><li id=\"3\" data-property=\"3\"></li></ul>")
	end
	# it "ul" do
